...
public final class RecoveryActivity extends AppCompatActivity {
    ...
    public static final String DEFAULT_CRASH_FILE_DIR_NAME = "crash_log";
    ...
    private boolean saveCrashData() {
        ...
        File dir = new File(Environment.getExternalStorageDirectory()+ File.separator + DEFAULT_CRASH_FILE_DIR_NAME);
        if (!dir.exists())
            dir.mkdirs();
